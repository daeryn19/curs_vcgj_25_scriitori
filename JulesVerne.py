...
def home():
    return render_template_string(
        ...
        continut=f"""
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/F%C3%A9lix_Nadar_1820-1910_portraits_Jules_Verne.jpg/960px-F%C3%A9lix_Nadar_1820-1910_portraits_Jules_Verne.jpg" alt="Jules Verne" style="width: 300px; border-radius: 8px; margin-top: 10px;">
            <p>Vizitează rutele:
                <ul>
...
def biografie():
    return render_template_string(
        ...
        continut=f"""
            <p>{get_biografie()}</p>
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Verne-majak-fronti.jpg/250px-Verne-majak-fronti.jpg">
...
def opere():
    ...
    return render_template_string(
        ...
        continut=f"""
            <ul>{opere_html}</ul>
            <img src="https://www.carti-online.ro/media/erc-press-colectia-completa-jules-verne-ii-17-volume-5502.jpg" alt="Opere Jules Verne" style="width: 300px; border-radius: 8px; margin-top: 10px;">
            <p><a class="back-btn" href="/">Înapoi la pagina principală</a></p>
        """
    )
